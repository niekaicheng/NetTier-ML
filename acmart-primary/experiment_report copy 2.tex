...
Substituting measured Stage 1 cost $C_1 = 6.12\,\mu s$ (E11), estimated DL cost $C_2 \approx 500\,\mu s$ (literature reference \cite{7}; Stage 2 latency benchmarking is identified as future work), and the pass-through rate at optimal tuning $\alpha(\tau=0.06) = 15.25\%$ (E17):
...
RF robust to perturbation & Prior belief (ensemble stability) & E14: RF $\varepsilon$=0.001 $\to$ 47\% & Overturned \\
